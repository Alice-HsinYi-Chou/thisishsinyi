document.addEventListener('DOMContentLoaded', function() {
  ...
  function initializeApp() {
    ...
    initMyPicks();
    initEmotionCarousel();
    initHoverAnimations(); // Initialize hover animations
  }
  ...
  function initHoverAnimations() {
    const navItems = document.querySelectorAll('.js-now-nav');
  ...
  function initMyPicks() {
    ...
    // Load default "BEST" content on page load
    function loadDefaultContent() {
      const defaultTheme = 'BEST';
      const themeData = contentData.mypicks[defaultTheme];
      
      if (themeData && themeTitle && themeContentEl) {
    ...
    // Load default content after a brief delay to ensure DOM is ready
    setTimeout(loadDefaultContent, 100);
  }
